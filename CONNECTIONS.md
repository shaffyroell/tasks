...
| **HubSpot CRM** | always | The pipeline lives in HubSpot — canonical deal/contact/company list and the single source of truth (see `HUBSPOT_SETUP.md`) |
...
| Meeting notes | Granola, Fireflies, Otter, Gemini | Provider connector / API key |
| Outreach | Lemlist | Lemlist MCP connector |
| CRM (source of truth) | HubSpot | HubSpot MCP connector (see `HUBSPOT_SETUP.md`) |
